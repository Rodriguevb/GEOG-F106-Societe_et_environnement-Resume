...
\fancyfoot[L]{Open source pour ajout ou modification: https://github.com/Rodriguevb/GEOG-F106-Societe\_et\_environnement-Resume/} % Numéro de page en bas de page à gauche
...
\pdfinfo{
    ...
    /Creator  (https://github.com/Rodriguevb/GEOG-F106-Societe_et_environnement-Resume/)
}
...
% Titre du PDF
\title{GEOG-F106 - Société et environnement\\Jean-Michel \textsc{Decroly}\\Frank \textsc{Pattyn}\\Résumé du cours}

\pdfinfo{
/Title(GEOG-F106 - Société et environnement - Résumé du cours)
}
...
\begin{document}
    ...
    \input{2.evolution_des_conceptions/text}
